...
= 1.0.2 =
* Added the ability to use either the cart Sub-Total or cart Total for the rates calculation

= 1.0.1 =
* Force numeric shipping values to string and control decimal precision on API call
