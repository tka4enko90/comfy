 ...
 * @extends \WC_Email
 */
class Wps_Rma_Exchange_Request_Cancel_Email extends WC_Email {
	/**
	 * Set email defaults
	 *
	 * @since 0.1
	...
	public function __construct() {
		...
		$this->id = 'wps_rma_exchange_request_cancel_email';

		// this is the title in WooCommerce Email settings.
		$this->title = 'RMA Exchange Request Cancel Email';
		// this is the description in WooCommerce email settings.
		$this->description = 'Admin to Customer Side Refund Request Cancel Emails<h1>These are shorcodes available for the custom email</h1><br><span>{site_title}, {site_address}, {site_url}, {message_date}, {order_id}{order_total},{billing_first_name},{billing_last_name},{billing_email},{billing_phone},{billing_country},{billing_address_1},{billing_address_2},{billing_state},{billing_postcode},{shipping_first_name},{shipping_last_name},{shipping_postcode},{shipping_country},{shipping_address_1},{shipping_address_2},{shipping_state},{shipping_postcode},{order_shipping},{payment_method_title}</span></b>';
		// these are the default heading and subject lines that can be overridden using the settings.
		$this->heading = 'RMA Exchange Request Cancel Email';
		$this->subject = 'New message has been received';

		// these define the locations of the templates that this email should use, we'll just use the new order template since this email is similar.
		$this->template_html  = 'wps-rma-exchange-request-cancel-email-template.php';
		$this->template_plain = 'wps-rma-exchange-request-cancel-email-template.php';
	...
	public function get_default_subject() {
		return esc_html__( 'Exchange Reuqest Cancel for order {order_id} message from {message_date}', 'woocommerce-rma-for-return-refund-and-exchange' );
	}
	...
	public function get_default_heading() {
		return esc_html__( 'Exchange Request Cancel Email', 'woocommerce-rma-for-return-refund-and-exchange' );
	}
