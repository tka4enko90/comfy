 ...
 * @extends \WC_Email
 */
class Wps_Rma_Refund_Email extends WC_Email {
	/**
	 * Set email defaults
	 *
	 * @since 0.1
	...
	public function __construct() {
		...
		$this->id = 'wps_rma_refund_email';

		// this is the title in WooCommerce Email settings.
		$this->title = 'RMA Return/Exchange Refund Email';
		// this is the description in WooCommerce email settings.
		$this->description = 'Admin to Customer Side Return/Exchange Refund Emails<h1>These are shorcodes available for the custom email</h1><br><span>{site_title},{site_address},{siteurl},{username},{refund_amount}</span></b>';
		// these are the default heading and subject lines that can be overridden using the settings.
		$this->heading = 'RMA Refund Email';
		$this->subject = 'New message has been received';

		// these define the locations of the templates that this email should use, we'll just use the new order template since this email is similar.
		$this->template_html  = 'wps-rma-refund-email-template.php';
		$this->template_plain = 'wps-rma-refund-email-template.php';
	 ...
	 * @param array  $refund_amu is order.
	 */
	public function trigger( $msg, $attachment, $to, $order_id, $refund_amu ) {
		...
		if ( $to ) {
			...
			$this->placeholders['{siteurl}']                    = home_url();
			$this->placeholders['{refund_amount}']                    = $refund_amu;
	...
	public function get_default_subject() {
		return esc_html__( 'Refund Amount for order {order_id} message from {message_date}', 'woocommerce-rma-for-return-refund-and-exchange' );
	}
	...
	public function get_default_heading() {
		return esc_html__( 'Refund Amount Email', 'woocommerce-rma-for-return-refund-and-exchange' );
	}
