...
if ( function_exists( 'add_image_size' ) ) {
	...
	add_image_size( 'cmf_search_result', 54, 54, true );
	add_image_size( 'cmf_logo', 91, 32, true );
	add_image_size( 'cmf_footer_partner', 33, 20, true );
	add_image_size( 'cmf_social_icon', 16, 16, true );
