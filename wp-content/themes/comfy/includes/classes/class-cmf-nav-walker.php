 ...
 */
class Cmf_Nav_Walker extends Walker_Nav_Menu {
	...
	public function start_lvl( &$output, $depth = 0, $args = null ) {
		...
		$zero_depth_html = ( 0 === $depth ) ? '<div class="sub-menu-wrap">' : '';

		$output .= "{$n}{$indent}{$zero_depth_html}<ul$class_names>{$n}";
	}
	...
	public function end_lvl( &$output, $depth = 0, $args = null ) {
		...
		$zero_depth_html = ( 0 === $depth ) ? '<div class="image-wrap">' . wp_get_attachment_image( $this->nav_image_id, 'cmf_header_nav_image' ) . '<p>' . $this->nav_text_under_image . '</p></div></div>' : '';

		$indent  = str_repeat( $t, $depth );
		$output .= "$indent</ul>{$zero_depth_html}{$n}";
	}
