...
function cmf_get_bundle_display_price( $product ) {
	...
	<span>
		...
		<span class="price"><?php echo wc_price( $min_price ); ?></span>
	</span>
	<span class="sale-persent"><?php echo __( 'Saves you NaN%' ); ?></span>
	<p class="credit">
		<?php echo __( 'or 4 interest-free-payments of' ) . wc_price( $min_price / 4 ) . ' ' . __( 'with', 'comfy' ) . ' '; ?>
